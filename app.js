 ...
 */
 ...
 setTimeout(function() {
   ...
   */
   $scope.removePerson = function(index, searchPerson){
...
var modalTemplate= '<div class="modal-header">   <a class="close" data-dismiss="modal" ng-click="cancel()"><i class="fa fa-times-circle-o" style="margin:10px;color:black;font-size:35px;"></i></a><h1>Customer</h1></div><div class="modal-body"><form >' +
        ...
        ' <button id = "myid" type="button" class="btn btn-success" ng-click="add(person.name)"><i class="ace-icon fa fa-check"></i>Save</button>' +
